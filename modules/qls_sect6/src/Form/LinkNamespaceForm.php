...
class LinkNamespaceForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['#attached']['library'][] = 'qls_sect6/link_namespace';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if($aliastype_select == 1){
       ...
       * モザイクへリンク
       */
      \Drupal::logger('qls_sect6')->notice('namespace:<pre>@object</pre>', ['@object' => print_r($namespace, TRUE)]); 
      $namespaceIds = IdGenerator::generateNamespacePath($namespace); // ルートネームスペース
      \Drupal::logger('qls_sect6')->notice('namespaceIds:<pre>@object</pre>', ['@object' => print_r($namespaceIds, TRUE)]); 
      ...
      // \Drupal::logger('qls_sect6')->notice('mosaicId:<pre>@object</pre>', ['@object' => print_r($mosaicId, TRUE)]);
      ...
      // \Drupal::logger('qls_sect6')->notice('linkaddress:<pre>@object</pre>', ['@object' => print_r($linkaddress, TRUE)]);
      ...
      // \Drupal::logger('qls_sect6')->notice('address:<pre>@object</pre>', ['@object' => print_r($address, TRUE)]);
      // \Drupal::logger('qls_sect6')->notice('new address:<pre>@object</pre>', ['@object' => print_r(new Address($linkaddress), TRUE)]);
    ...
    // \Drupal::logger('qls_sect6')->notice('payload:<pre>@object</pre>', ['@object' => print_r($payload, TRUE)]);
