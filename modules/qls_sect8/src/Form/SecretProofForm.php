...
class SecretProofForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // \Drupal::logger('qls_sect8')->notice('payload: @payload', ['@payload' => $payload]);
    // \Drupal::logger('qls_sect8')->notice('Secret Proof TxHash: @hash', ['@hash' => $facade->hashTransaction($proofTx)]);
