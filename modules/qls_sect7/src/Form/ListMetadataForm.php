...
class ListMetadataForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['#attached']['library'][] = 'qls_sect7/metadata_namespace';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // \Drupal::logger('qls_sect7')->notice('sourceAddress:<pre>@object</pre>', ['@object' => print_r($sourceAddress, TRUE)]); 
  ...
  private function flattenMetadataData($metadataInfo) {
    ...
    foreach ($metadataInfo->getData() as $metadataItem) {
      ...
      // ログに出力
      // \Drupal::logger('qls_sect7')->notice("ID: $id, Source: $sourceAddress, Target: $targetAddress, Value: $decodedValue"); 
    }
