...
class MetadataMosaicForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['#attached']['library'][] = 'qls_sect7/metadata_mosaic';
    ...
    // \Drupal::logger('qls_sect7')->notice('source_pvtKey:<pre>@object</pre>', ['@object' => print_r($source_pvtKey, TRUE)]);
    // if($source_pvtKey) {
    //   $form['mosaic_fieldset']['mosaic'] = [
    //     '#type' => 'select',
    //     '#title' => $this->t('Mosaic'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // \Drupal::logger('qls_sect7')->notice('targetMosaic:<pre>@object</pre>', ['@object' => print_r($targetMosaic, TRUE)]);
    // キーと値の設定
    $metadata_key = $form_state->getValue('metadata_key');
    $metadata_value = $form_state->getValue('metadata_value');

    $keyId = Metadata::metadataGenerateKey($metadata_key);
    // \Drupal::logger('qls_sect7')->notice('keyId:<pre>@object</pre>', ['@object' => print_r($keyId, TRUE)]);
    ...
    // \Drupal::logger('qls_sect7')->notice('oldValue:<pre>@object</pre>', ['@object' => print_r($oldValue, TRUE)]);
    $updateValue = Metadata::metadataUpdateValue($oldValue, $newValue, true);
    // \Drupal::logger('qls_sect7')->notice('updateValue:<pre>@object</pre>', ['@object' => print_r($updateValue, TRUE)]);
    // $targetMosaicID = new UnresolvedMosaicId(hexdec($targetMosaic)); 
    // \Drupal::logger('qls_sect7')->notice('targetMosaicID:<pre>@object</pre>', ['@object' => print_r($targetMosaicID, TRUE)]);
    ...
    // \Drupal::logger('qls_sect7')->notice('tx:<pre>@object</pre>', ['@object' => print_r($tx, TRUE)]);
    // マークルハッシュの算出
  ...
  private function getOwnedMosaicOptions(FormStateInterface $form_state) {
    ...
    // \Drupal::logger('qls_sect7')->notice('384:source_pvtKey:<pre>@object</pre>', ['@object' => print_r($source_pvtKey, TRUE)]);
    $options = [];
    ...
    // \Drupal::logger('qls_sect7')->notice('393:<pre>@object</pre>', ['@object' => print_r($sourceKey->address->__tostring(), TRUE)]);
    ...
    // 
    // \Drupal::logger('qls_sect7')->notice('406:<pre>@object</pre>', ['@object' => print_r($json_data, TRUE)]); 
    ...
    // ];
    // \Drupal::logger('qls_sect7')->notice('415:<pre>@object</pre>', ['@object' => print_r($options, TRUE)]); 
    return $options;
  }
  ...
  public function promptCallback(array $form, FormStateInterface $form_state) {
    ...
    $options = $this->getOwnedMosaicOptions($form_state);
    // \Drupal::logger('qls_sect7')->notice('Mosaic options: <pre>@data</pre>', ['@data' => print_r($options, TRUE)]);
    \Drupal::logger('qls_sect7')->notice('Mosaic options after AJAX: <pre>@data</pre>', ['@data' => print_r($options, TRUE)]);
  ...
  // \Drupal::logger('qls_sect7')->notice('Response: <pre>@response</pre>', ['@response' => print_r($response, TRUE)]);
  ...
  // return $response;
    ...
    // }
    // try {
    //   // \Drupal::logger('qls_sect7')->notice('436:<pre>@data</pre>', ['@data' => print_r($form['mosaic_fieldset'], TRUE)]);
    //   return $form['mosaic_fieldset'];
    // } catch (\Exception $e) {
    //     \Drupal::logger('qls_sect7')->error('Error in promptCallback: @message', ['@message' => $e->getMessage()]);
    //     throw $e;
    // }
  }
}