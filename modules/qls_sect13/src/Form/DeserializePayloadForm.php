...
class DeserializePayloadForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['description'] = [
      '#type' => 'item',
      '#markup' => '13.1.2 '.$this->t('payload確認'),
    ];
  ...
  public function promptCallback(array &$form, FormStateInterface $form_state) {
    ...
    $HRoot = $blockApi->getBlockByHeight($height);
    $HRootHash = new Hash256($HRoot["block"]["transactions_hash"]);

    $merkleProof = $blockApi->getMerkleTransaction($height, $leafhash);
