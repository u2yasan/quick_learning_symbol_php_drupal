...
namespace Drupal\qls_sect13\Form;
...
class VerifyAccountInfoForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['description'] = [
      '#type' => 'item',
      '#markup' => '13.3.1 '.$this->t('アカウント情報の検証'),
    ];
  ...
  public function promptCallback(array &$form, FormStateInterface $form_state) {
    ...
    $addressInfo = $accountApi->getAccountInfo($addressRawAddress);
    ...
    $stateProof = $accountApi->getAccountInfoMerkle($addressRawAddress);
  ...
  public function checkState($stateProof, $stateHash, $pathHash, $rootHash) {
    ...
    \Drupal::logger('qls_sect13')->info('treeRootHash === rootHash: ' . ($treeRootHash === $rootHash));
    \Drupal::logger('qls_sect13')->info('treePathHash === pathHash: ' . ($treePathHash === $pathHash));
