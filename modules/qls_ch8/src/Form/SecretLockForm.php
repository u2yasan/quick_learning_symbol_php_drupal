...
class SecretLockForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // // \Drupal::logger('qls_ch8')->notice('Account Info: @account_info', ['@account_info' => $account_info]);
    // $recipientAddress = $account_info['address'];
    // \Drupal::logger('qls_ch8')->notice('Recipient Address: @recipientAddress', ['@recipientAddress' => $recipientAddress]);
    ...
    // \Drupal::logger('qls_ch8')->notice('Secret Lock lockTx: @lockTx', ['@lockTx' => $lockTx]);
    // 署名
