...
class SimpleTransferTransactionForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if($message){
      ...
      //$messageData = $message;
      // \Drupal::logger('qls_sect4')->notice('<pre>@object</pre>', ['@object' => print_r($messageData, TRUE)]);  
      ...
      if($is_encrypt_message){
        ...
        // \Drupal::logger('qls_sect4')->notice('<pre>@object</pre>', ['@object' => print_r($account_info, TRUE)]);
        sleep(1);
        ...
        if ($account_info) {
          ...
          // \Drupal::logger('qls_sect4')->notice('<pre>@object</pre>', ['@object' => print_r($recipent_publicKey_str, TRUE)]);
          // $recipent_publicKey = new CryptoPublicKey($recipent_publicKey_str);
          // \Drupal::logger('qls_sect4')->notice('<pre>@object</pre>', ['@object' => print_r($recipent_publicKey, TRUE)]);
    ...
    // \Drupal::logger('qls_sect4')->notice('<pre>@object</pre>', ['@object' => print_r($transferTx, TRUE)]);  
    // 出力例
    // /admin/reports/dblog でログを確認
    // \Drupal::logger('qls_sect4')->notice('<pre>@object</pre>', ['@object' => print_r($facade, TRUE)]);
